...
.to(coulomb_hide,1,{autoAlpha:1, delay:3})
.to(coulomb_hide, 2, {scaleX:1, scaleY:1,transformOrigin:"50 25"})
.to(sixPointTwoFour_hide,1,{autoAlpha:1})
.to(coulomb_hide, 2, {scaleX:0, scaleY:0,transformOrigin:"50 25", delay:5.5})
...
.to([gnd1copy,s1copy,switched1copy,lightBulbFilamentcopy,switched2copy], .1, {strokeWidth:6, delay:0})
