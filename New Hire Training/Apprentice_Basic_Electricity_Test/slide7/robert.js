...
//Diagram 1 Current and Highlights
var diagram1Current = [];
...
TweenMax.to([diagram1S1],0,{rotation:20, transformOrigin:"0 20"})
...
.to([chartE_hide,chartR_hide,chartP_hide],1, {autoAlpha:1})
...
.to([diagram1S1],1,{rotation:0, transformOrigin:"0 20", delay:1})
.to(diagram1Wire1Current,1,{autoAlpha:1})
