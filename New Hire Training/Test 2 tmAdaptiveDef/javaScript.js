...
for(i=0; i<noPathsLength; i++){
	var path = document.createElementNS('http://www.w3.org/2000/svg', 'path');
		...
		path.setAttribute('onclick','wireClicked(this);console.log(this.id)');
...
// showWindow.setAttribute("onclick", console.log("showWindow._gsTransform.x"))
...
function changeColors(myColor){
	console.log("x:" + showWindow._gsTransform.x + ", y:" + showWindow._gsTransform.y + ", scaleX:"+ showWindow._gsTransform.scaleX + ", scaleY:" + showWindow._gsTransform.scaleY);
